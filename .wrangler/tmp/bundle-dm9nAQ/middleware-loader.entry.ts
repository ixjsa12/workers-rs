...
import {
	...
	__facade_invoke__,
	__facade_register__,
} from "/workspaces/workers-rs/node_modules/wrangler/templates/middleware/common.ts";

import worker from "/workspaces/workers-rs/.wrangler/tmp/bundle-dm9nAQ/middleware-insertion-facade.js";

// We need to preserve all of the exports from the worker
export * from "/workspaces/workers-rs/.wrangler/tmp/bundle-dm9nAQ/middleware-insertion-facade.js";
